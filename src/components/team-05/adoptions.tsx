    ...
    <div className="flex flex-col justify-center py-8 sm:py-12 px-6 lg:px-8 max-w-screen-xl mx-auto gap-16">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <h2 className="mt-3 text-4xl sm:text-5xl font-bold tracking-tight">
          Find Your <span className="text-primary">Fur-ever</span> Friend Today.
        </h2>
        <p className="mt-6 text-base sm:text-lg">
          Ready to welcome a new companion? Browse hundreds of loving pets ready for their forever homes. Your perfect match is just a click away.
        </p>
...
const AddListing = ({
  ...
  const handle = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await upload("adoptions", `images/${unix}`, image);
